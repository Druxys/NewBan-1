...
public class BaseModelORM {
    ...
    public PreparedStatement getSelectQuery(Connection dbConnection, ArrayList<String> fields, ArrayList filters, String explo, String tableName, String adj){
        ...
        selectQueryString = selectQueryString + " "+ explo + " " + tableName + " " + adj + " ";
